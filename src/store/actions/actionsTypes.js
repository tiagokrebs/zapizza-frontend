...
const CLIENTE = {
    ...
    SELECT_CLIENTE_START: 'SELECT_CLIENTE_START',
    SELECT_CLIENTE_ERROR: 'SELECT_CLIENTE_ERROR',
    SELECT_CLIENTE_SUCCESS: 'SELECT_CLIENTE_SUCCES',
    GET_CLIENTE_START: 'CLIENTE_GET_CLIENTE_START',
    GET_CLIENTE_ERROR: 'CLIENTE_GET_CLIENTE_ERROR',
    GET_CLIENTE_SUCCESS: 'CLIENTE_GET_CLIENTE_SUCCESS',
};

const PEDIDO = {
    GET_PEDIDO_LIST_START: 'PEDIDO_GET_PEDIDO_LIST_START',
    GET_PEDIDO_LIST_ERROR: 'PEDIDO_GET_PEDIDO_LIST_ERROR',
    GET_PEDIDO_LIST_SUCCESS: 'PEDIDO_GET_PEDIDO_LIST_SUCCESS',
    POST_PEDIDO_START: 'PEDIDO_POST_PEDIDO_START',
    POST_PEDIDO_ERROR: 'PEDIDO_POST_PEDIDO_ERROR',
    POST_PEDIDO_SUCCESS: 'PEDIDO_POST_PEDIDO_SUCCES',
    PUT_PEDIDO_START: 'PEDIDO_PUT_PEDIDO_START',
    PUT_PEDIDO_ERROR: 'PEDIDO_PUT_PEDIDO_ERROR',
    PUT_PEDIDO_SUCCESS: 'PEDIDO_PUT_PEDIDO_SUCCES',
    PUT_PEDIDO_ENABLE_START: 'PEDIDO_PUT_PEDIDO_ENABLE_START',
    PUT_PEDIDO_ENABLE_ERROR: 'PEDIDO_PUT_PEDIDO_ENABLE_ERROR',
    PUT_PEDIDO_ENABLE_SUCCESS: 'PEDIDO_PUT_PEDIDO_ENABLE_SUCCES',
    DELETE_PEDIDO_START: 'PEDIDO_DELETE_PEDIDO_START',
    DELETE_PEDIDO_ERROR: 'PEDIDO_DELETE_PEDIDO_ERROR',
    DELETE_PEDIDO_SUCCESS: 'PEDIDO_DELETE_PEDIDO_SUCCES',
};

export {
    AUTH, USER, TAMANHO, SABOR, BORDA, ADICIONAL, CLIENTE, PEDIDO
};